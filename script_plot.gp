...
plot sin(x**3*15)+cos(7*x+9)**5+1 with lines lw 2 lc rgb "#D81B60" title "f(x)", 0.844806+(-25.7106)*(x-1)**1+(-629.603)*(x-1)**2+9384.8*(x-1)**3+142511*(x-1)**4+(-642671)*(x-1)**5+(-1.24499e+07)*(x-1)**6+(-2.27835e+06)*(x-1)**7+5.18558e+08*(x-1)**8+1.67019e+09*(x-1)**9 with lines lw 2 lc rgb "#1E88E5"  title "g(x)", (-25.7106)*x+26.5554 with lines lw 2 lc rgb "#43A047"  title "h(x)", '-' with points pt 7 ps 0.5 lc "orange" title "A"
1 0.844806
e