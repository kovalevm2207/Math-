...
plot sin(x**3*15)+cos(7*x+9)**4+1 with lines lw 2 lc rgb "#D81B60" title "f(x)", 1.80404+(-7.35084)*(x-0.11)**1+(-42.0808)*(x-0.11)**2+609.661*(x-0.11)**3+1220.2*(x-0.11)**4+(-19042.7)*(x-0.11)**5+(-19886.7)*(x-0.11)**6+335046*(x-0.11)**7+234658*(x-0.11)**8+(-3.59705e+06)*(x-0.11)**9+(-1.95643e+06)*(x-0.11)**10 with lines lw 2 lc rgb "#1E88E5"  title "g(x)", (-7.35084)*x+2.61263 with lines lw 2 lc rgb "#43A047"  title "h(x)", '-' with points pt 7 ps 0.5 lc "orange" title "A"
0.11 1.80404
e